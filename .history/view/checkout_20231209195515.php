            ...
            <div class="checkout-left">
              <div class="order">
                ...
                <div action="" class="order-form order-info">
                  ...
                  <input name="tendat" class="order-input" type="text" placeholder="Nhập họ tên" value="<?=$_SESSION['name']?>" /> <br />
                  <div style="color:red; margin-bottom:5px"><?=$errname?></div>
                  <input name="emaildat" class="order-input" type="text" placeholder="Nhập email"  value="<?=$_SESSION['email']?>"/> <br />
                  <div style="color:red; margin-bottom:5px"><?=$erremail?></div>
                  <input name="sdtdat" class="order-input" type="text" placeholder="Nhập số điên thoại"  value="<?=$_SESSION['sdt']?>"/> <br />
                  <div style="color:red; margin-bottom:5px"><?=$errsdt?></div>
                  <input name="diachidat" class="order-input" type="text" placeholder="Nhập địa chỉ"  value="<?=$_SESSION['diachi']?>"/> <br />
                  <div style="color:red; margin-bottom:5px"><?=$errdiachi?></div>
                </div>
                ...
                <div class="diachikhac">
                  ...
                  <div class="order-form order-info">
                    <input name="tennhan" class="order-input" type="text" placeholder="Nhập họ tên"  value="<?=$_SESSION['namenhan']?>"/> <br />
                    <div style="color:red;margin-bottom:5px"><?=$errnamenhan?></div>
                    <input name="emailnhan" class="order-input" type="text" placeholder="Nhập email"  value="<?=$_SESSION['emailnhan']?>"/> <br />
                    <div style="color:red; margin-bottom:5px"><?=$erremailnhan?></div>
                    <input name="sdtnhan" class="order-input" type="text" placeholder="Nhập số điên thoại"  value="<?=$_SESSION['sdtnhan']?>"/> <br />
                    <div style="color:red; margin-bottom:5px"><?=$errsdtnhan?></div>
                    <input name="diachinhan" class="order-input" type="text" placeholder="Nhập địa chỉ"  value="<?=$_SESSION['diachinhan']?>"/> <br />
                    <div style="color:red; margin-bottom:5px"><?=$errdiachinhan?></div>
                  </div>
                </div>
              </div>
              <div class="order-pt">
            ...
            <div class="checkout-right">
              <div class="checkout-right-box">
                ...
                <div class="voucher">
                    ...
                    <div style="color:red; margin:10px 0">'.$errvoucher.'</div>';
                    ?>
