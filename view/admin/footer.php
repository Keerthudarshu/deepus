          ...
          <div class="dashboard-main">
            <div class="dashboard-left">
              <ul class="dashboard-menu">
                <li class="dashboard-menu-list">
                  <a href="#" class="dashboard-menu-link active" data-tab="1">
                    <i class="fa fa-tachometer" aria-hidden="true"></i>
                    Dashboard
                  </a>
                </li>
                <li class="dashboard-menu-list">
                  <a href="#" class="dashboard-menu-link" data-tab="2">
                    <i class="fa fa-list" aria-hidden="true"></i>
                    Danh mục sản phẩm
                  </a>
                </li>
                <li class="dashboard-menu-list">
                  <a href="#" class="dashboard-menu-link" data-tab="3">
                    <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                    Sản phẩm
                  </a>
                </li>
                <li class="dashboard-menu-list">
                  <a href="#" class="dashboard-menu-link" data-tab="4">
                    <i class="fa fa-user" aria-hidden="true"></i>
                    Tài khoản
                  </a>
                </li>
                <li class="dashboard-menu-list">
                  <a href="#" class="dashboard-menu-link" data-tab="5">
                    <i class="fa fa-commenting" aria-hidden="true"></i>
                    Bình luận
                  </a>
                </li>
                <li class="dashboard-menu-list">
                  <a href="#" class="dashboard-menu-link">
            ...
            <div class="dashboard-right">
              <div class="dashboard-content active" data-tab="1">
                ...
                <h2 class="title">Biểu đồ thống kê</h2>
                <div class="statistical-main">
                  <div class="statistical-left">
                    <img src="../layout/assets/images/thongke.png" alt="" />
                  </div>
                  <div class="statistical-right">
                    <img src="../layout/assets/images/bieudo.png" alt="" />
                  </div>
                </div>
              </div>
                ...
                <table class="categori">
                  ...
                  <tbody>
                    <tr>
                      <td>Áo thun</td>
                      <td>
                        <a href="../admin/capnhatdanhmuc.html" class="edit">Sửa</a>
                        <a href="#" class="del">Xóa</a>
                      </td>
                    </tr>
                    <tr>
                      <td>Áo thun</td>
              ...
              <div class="dashboard-content" data-tab="3">
                <div class="dashboard-heading">
                  <h2 class="title-primary">Quản lí sản phẩm</h2>
                  <a href="../admin/themsanpham.html">
                    <button class="dashboard-add">
                      <i class="fa fa-plus" aria-hidden="true"></i>
                      Thêm
                    </button>
                ...
                <table class="product">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Áo thun</td>
                      <td>
                        <a href="../admin/capnhatsanpham.html" class="edit">Sửa</a>
                        <a href="#" class="del pl-10">Xóa</a>
                      </td>
                    </tr>
                    <tr>
                      <td>
              ...
              <div class="dashboard-content" data-tab="4">
                <div class="dashboard-heading">
                  <h2 class="title-primary">Danh sách tài khoản</h2>
                  <button class="dashboard-add">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                    Thêm
                  </button>
                ...
                <table class="product">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Lê Thị Mỹ Hồng</td>
                      <td>hong1208@gmail.com</td>
                      <td>288/3 Phùng Khắc Khoan</td>
                      <td>0776831909</td>
                      <td>
                        <a href="#" class="edit">Sửa</a>
                        <a href="#" class="del pl-10">Xóa</a>
              ...
              <div class="dashboard-content" data-tab="5">
                <div class="dashboard-heading">
                  <h2 class="title-primary">Danh sách bình luận</h2>
                  <button class="dashboard-add">
                    <i class="fa fa-plus" aria-hidden="true"></i>
                    Thêm
                  </button>
                </div>
                <table class="categori comment">
                  <thead>
                    <tr>
                      <th>Mã</th>
                      <th>IdUser</th>
