<?php
    ...
    // Only show products in the 'boys' category
    ...
    foreach ($_SESSION['product'] as $item) {
      ...
      $is_boys = false;
      if (isset($item['category']) && strtolower($item['category']) === 'boys') {
        $is_boys = true;
      } elseif (isset($item['gioitinh']) && (strtolower($item['gioitinh']) === 'boys' || $item['gioitinh'] == 1)) {
        // Assuming 'gioitinh' == 1 means boys (check your DB convention)
        $is_boys = true;
      }
      if ($is_boys) {
